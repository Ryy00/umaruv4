...
export const setup = {
  ...
  usages: ["[text] | [text]"],
  mainScreenshot: ["/media/avatarlogo/screenshot/main.jpg"],
  screenshot: ["/media/avatarlogo/screenshot/main.jpg"],
  cooldown: 5,
  isPrefix: true
};
export const domain = {"avatarlogo": setup.name}
export const execCommand = async function({api, event, key, kernel, umaru, args, keyGenerator, Users, context,   prefix, usage}) {
  ...
  let image = await kernel.readStream(["avatarlogo"], {key: key, text1: text1, text2: text2});
