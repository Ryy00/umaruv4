...
export const domain = {"fuck3": setup.name}
export const execCommand = async function({api, event, key, kernel, umaru, args, keyGenerator, Users, prefix, context, usage}) {
  ...
  let image = await kernel.readStream(["fuck3"], {key: key, senderID: await Users.getImage(male), targetID: await Users.getImage(female)});
