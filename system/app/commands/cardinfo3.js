...
export const setup = {
  ...
  mainScreenshot: ["/media/cardinfo3/screenshot/main.jpg"],
  screenshot: ["/media/cardinfo3/screenshot/1.jpg", "/media/cardinfo3/screenshot/2.jpg", "/media/cardinfo3/screenshot/3.jpg"],
  cooldown: 30,
  isPrefix: true
};
export const domain = {"cardinfo3": setup.name}
export const execCommand = async function({api, event, key, kernel, umaru, args, keyGenerator, Users, Threads, getUsers, context}) {
  ...
  let image = await kernel.readStream(["cardinfo3"], { key: key, uid: mentions[0], info: await Users.getInfoV2(mentions[0]), av1: await Users.getImage(mentions[0])})
