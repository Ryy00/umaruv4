...
export const domain = {"married2": setup.name}
export const execCommand = async function({api, event, key, kernel, umaru, args, keyGenerator, Users, prefix, context, usage}) {
  ...
  let image = await kernel.readStream(["married2"], {key: key, senderID: await Users.getImage(male), targetID: await Users.getImage(female)});
