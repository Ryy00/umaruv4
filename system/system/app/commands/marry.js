...
export const setup = {
  ...
  version: "40.0.0",
  permission: "Users",
  creator: "Thiệu Trung Kiên, John Lester",
...
export const domain = {"marry": setup.name}
export const execCommand = async function({api, event, key, kernel, umaru, args, keyGenerator, Users, prefix, context, usage}) {
  ...
  let image = await kernel.readStream(["marry"], {key: key, senderID: await Users.getImage(male), targetID: await Users.getImage(female)});
