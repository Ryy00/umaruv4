[![Socket Badge](https://socket.dev/api/badge/npm/package/fca-umaru-v2)](https://socket.dev/npm/package/fca-umaru-v2)
...
```bash
npm install fca-umaru-v2@latest
```
Hoặc
```bash
npm i fca-umaru-v2@latest
```
...
```javascript
const login = require("fca-umaru-v2"); // lấy từ lib ra 
...
```js
    var login = require('fca-umaru-v2')
```
...
```js
const fs = require("fs");
const login = require("fca-umaru-v2");
